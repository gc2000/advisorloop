...
4. **Compiler** — the frontend assembles consultant-approved cards into a one-page bilingual (EN/ZH) diagnostic report, closing with: *"This is a rapid diagnostic. Full implementation roadmap available upon consultation."* — the report is the free/low-cost lead-in; the paid engagement is the implementation.
...
Open http://localhost:3000, click "Load sample WhatsApp log" to try it with the included demo material, then click Analyze.
